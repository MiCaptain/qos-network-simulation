...
echo "Iniciando trafego de fundo no cliente 03 para $SERVER_IP, porta $PORT, duracao $DURATION segundos, banda $BANDWIDTH..."

iperf -c $SERVER_IP -p $PORT -t $DURATION -b $BANDWIDTH -i 1 -u > logs/cliente03_${PORT}_iperf_bt.txt &
